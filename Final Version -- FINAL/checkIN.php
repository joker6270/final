...
$DATE=date('G:i:s A');
    ...
    $query = "SELECT * FROM users WHERE Iqama='$Iqama'";
    $query_run = mysqli_query($con, $query);
    if(mysqli_num_rows($query_run) > 0)
    {
			  echo "'<script type=text/javascript> Swal.fire('Sorry', 'Your ID is already exist!', 'warning') </script>'";


    }
    else{
      if(!empty($NameV) && !empty($Company) && !empty($Iqama) && !empty($Purpose) && !empty($Accompainied))
      {
        //save to database

        	$query = "insert into users (NameV,Company,Iqama,Purpose,Accompainied,check_In,check_out) values ('$NameV','$Company','$Iqama','$Purpose','$Accompainied','$DATE','$SetCheckOut')";
      ...
      {
        echo "'<script type=text/javascript> Swal.fire('Sorry', 'Please Enter some valid information', 'warning') </script>'";
      }
    }
	}
  ...
  <body>
      ...
      <form  method="post">
        ...
        <hr>
          ...
          <input type="text" name="NameV" id="name" placeholder="Name" />

          <label id="icon" for="company"><i class="fas fa-building"></i></label>

          <input type="text" name="Company" id="name" placeholder="Company" />

          <label id="icon" for="ID number"><i class="fas fa-id-card"></i></label>

          <input type="text" name="Iqama" id="name" placeholder="ID number" />

          <label id="icon" for="purepose"><i class="fas fa-question-circle"></i></label>

          <input type="text" name="Purpose" id="name" placeholder="purepose of visit" />

          <label id="icon" for="accompanied by"><i class="fas fa-users"></i></label>

          <input type="text" name="Accompainied" id="name" placeholder="accompanied by" />
        <br>
